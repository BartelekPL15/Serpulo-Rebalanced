...
Blocks.cyclone.ammoTypes.get(Items.metaglass).splashDamage = 40;
Blocks.cyclone.ammoTypes.get(Items.metaglass).splashDamageRadius = 24;
...
Blocks.cyclone.ammoTypes.get(Items.metaglass).fragBullets = 8;
Blocks.cyclone.ammoTypes.get(Items.metaglass).rangeChange = 32;
Blocks.cyclone.ammoTypes.get(Items.plastanium).damage = 15;
Blocks.cyclone.ammoTypes.get(Items.plastanium).splashDamage = 60;
Blocks.cyclone.ammoTypes.get(Items.plastanium).splashDamageRadius = 28;
Blocks.cyclone.ammoTypes.get(Items.plastanium).ammoMultiplier = 2;
Blocks.cyclone.ammoTypes.get(Items.plastanium).fragBullet.damage = 75;
...
Blocks.cyclone.ammoTypes.get(Items.blastCompound).splashDamageRadius = 56;
